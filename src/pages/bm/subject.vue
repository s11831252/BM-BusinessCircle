  ...
  <div class="index">
    ...
    <div class="main">
      ...
      <div class="tjdp">
        ...
        <ul>
          <li v-for="(item,index) in RecommendList" :key="index" @click="goShoppingInfo(item.sId)">
            <img :src="ImageBaseUrl+item.sLogo" alt>
      ...
      <div class="fjsj">
        ...
        <div v-for="(item,index) in RecommendList" :key="index" @click="goShoppingInfo(item.sId)">
          <div class="nr">
            <div class="f1">
              <img :src="ImageBaseUrl+item.sLogo" alt>
            </div>
            <div class="f2">
              ...
              <p>
                店铺总综合评分：
                <span>{{item.StoreScore}}</span>
              </p>
              <p>
                  <span class="label">{{item.StoreType}}</span>
              </p>
            </div>
          ...
          <div class="bor">
            <ul>
              <li v-for="(item2,index2) in item.Goods_list" :key="index2" @click.stop="goGoodsInfo(item.sId,item2.gId,item.sName)">
...
export default {
  ...
  async mounted() {
    ...
    if (this.$route.query.title && this.$route.query.MainType) {
      ...
      //获取推荐店铺
      var rep = await this.$BMAPI.ShopTypeApi_GetScircleeInfo(this.MainType);
      if (rep.ret == 0) {
